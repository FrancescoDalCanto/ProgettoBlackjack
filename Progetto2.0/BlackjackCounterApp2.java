...
public class BlackjackCounterApp2 extends JFrame {
    ...
    private void calculateTotal() {
        ...
        int dealerCard = 0;  // Ottieni la carta scoperta del dealer
    ...
    private String decideMossa(int totalValue, int dealerCard, int subt) {
        ...
        return ""; // Restituisci una stringa vuota come valore predefinito
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new BlackjackCounterApp2());
    }
}
